...
<div class="page-header">
  <div class="container-fluid">
    <h2 class="h5 no-margin-bottom">Create a Service</h2>
  </div>
</div>
            ...
            @endif
              <form method="post" action="{{ route('services.store') }}">
                  ...
                  <div class="form-group">
                      ...
                      <input type="number" size="8" step="0.01" class="form-control" name="hourRate"/>
                  </div>
                  <div class="form-group">
                      <label for="minimumHours">Minimum hours:</label>
                      <input type="number" class="form-control" name="minimumHours"/>
                  </div>
                  <div class="form-group">
                      <label for="minuteIncrements">Minute Increments:</label>
                      <input type="number" class="form-control" name="minuteIncrements"/>
                  </div>
                   <div class="form-group">    
