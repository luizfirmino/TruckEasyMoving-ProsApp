$(function () {
    ...
    $(document).ready(function(){
        ...
        if ($('#jobsPendingConfirmationModal').length > 0) {
            $('#jobsPendingConfirmationModal').modal('show');
        }
    });

    // Admin - Services Create/Edit
    $("#btnAddServiceRoles").click(function(e){
        
        /*
        selectValues = $("#comboRoles option:selected");
        ...
        */
        ...
        $('#roles')
            .append($('<option selected value=' + $("#comboRoles").val() + '>', { value : $("#comboRoles").val() })
            .text($('#comboRoles option:selected').text()));
        
    });
    
    // Admin - Services Create/Edit
    $("#btnDeleteServiceRoles").click(function(e){
